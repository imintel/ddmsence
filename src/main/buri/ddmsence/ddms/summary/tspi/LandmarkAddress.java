 ...
 * @since 2.2.0
 */
public final class LandmarkAddress extends AbstractTspiAddress {
	 ...
	 */
	public LandmarkAddress(Element element) throws InvalidDDMSException {
		super(element);
	}
	...
	protected void validate() throws InvalidDDMSException {
		Util.requireQName(getXOMElement(), getNamespace(), LandmarkAddress.getName(getDDMSVersion()));
		super.validate();
	}
	...
	public boolean equals(Object obj) {
		if (!super.equals(obj) || !(obj instanceof LandmarkAddress))
			return (false);
		return (true);
	}
	...
	public static class Builder extends AbstractTspiAddress.Builder {
		 ...
		 */
		public Builder(LandmarkAddress address) {
			super(address);
		}
		 ...
		 * @see IBuilder#commit()
		 */
		public LandmarkAddress commit() throws InvalidDDMSException {
			if (isEmpty())
				return (null);
			return (new LandmarkAddress(commitXml()));
		}
	}
}