...
public final class NumberedThoroughfareAddress extends AbstractTspiAddress {
	...
	protected void validate() throws InvalidDDMSException {
		Util.requireQName(getXOMElement(), getNamespace(), NumberedThoroughfareAddress.getName(getDDMSVersion()));
		super.validate();
	}
	...
	public boolean equals(Object obj) {
		if (!super.equals(obj) || !(obj instanceof NumberedThoroughfareAddress))
			return (false);
		return (true);
	}
	...
	public static class Builder extends AbstractTspiAddress.Builder {
		 ...
		 */
		public Builder(NumberedThoroughfareAddress address) {
			super(address);
		}
