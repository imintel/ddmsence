 ...
 * @since 2.2.0
 */
public final class Ellipse extends AbstractTspiShape {
	 ...
	 */
	public Ellipse(Element element) throws InvalidDDMSException {
		super(element);
	}
	...
	protected void validate() throws InvalidDDMSException {
		Util.requireQName(getXOMElement(), getNamespace(), Ellipse.getName(getDDMSVersion()));
		super.validate();
	}
	...
	public boolean equals(Object obj) {
		if (!super.equals(obj) || !(obj instanceof Ellipse))
			return (false);
		return (true);
	}
	...
	public static class Builder extends AbstractTspiShape.Builder {
		 ...
		 */
		public Builder(Ellipse address) {
			super(address);
		}
		 ...
		 * @see IBuilder#commit()
		 */
		public Ellipse commit() throws InvalidDDMSException {
			if (isEmpty())
				return (null);
			return (new Ellipse(commitXml()));
		}
	}
}