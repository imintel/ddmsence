 ...
 * @since 2.2.0
 */
public final class IntersectionAddress extends AbstractTspiAddress {
	 ...
	 */
	public IntersectionAddress(Element element) throws InvalidDDMSException {
		super(element);
	}
	...
	protected void validate() throws InvalidDDMSException {
		Util.requireQName(getXOMElement(), getNamespace(), IntersectionAddress.getName(getDDMSVersion()));
		super.validate();
	}
	...
	public boolean equals(Object obj) {
		if (!super.equals(obj) || !(obj instanceof IntersectionAddress))
			return (false);
		return (true);
	}
	...
	public static class Builder extends AbstractTspiAddress.Builder {
		 ...
		 */
		public Builder(IntersectionAddress address) {
			super(address);
		}
		 ...
		 * @see IBuilder#commit()
		 */
		public IntersectionAddress commit() throws InvalidDDMSException {
			if (isEmpty())
				return (null);
			return (new IntersectionAddress(commitXml()));
		}
	}
}