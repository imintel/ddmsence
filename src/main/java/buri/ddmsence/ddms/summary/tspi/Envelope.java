 ...
 * @since 2.2.0
 */
public final class Envelope extends AbstractTspiShape {
	...
	protected void validate() throws InvalidDDMSException {
		Util.requireQName(getXOMElement(), getNamespace(), Envelope.getName(getDDMSVersion()));
		super.validate();
	}
	...
	public boolean equals(Object obj) {
		if (!super.equals(obj) || !(obj instanceof Envelope))
			return (false);
		return (true);
	}
	...
	public static class Builder extends AbstractTspiShape.Builder {
		 ...
		 */
		public Builder(Envelope address) {
			super(address);
		}
		 ...
		 * @see IBuilder#commit()
		 */
		public Envelope commit() throws InvalidDDMSException {
			if (isEmpty())
				return (null);
			return (new Envelope(commitXml()));
		}
	}
}