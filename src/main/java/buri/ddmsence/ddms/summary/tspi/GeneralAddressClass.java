 ...
 * @since 2.2.0
 */
public final class GeneralAddressClass extends AbstractTspiAddress {
	 ...
	 */
	public GeneralAddressClass(Element element) throws InvalidDDMSException {
		super(element);
	}
	...
	protected void validate() throws InvalidDDMSException {
		Util.requireQName(getXOMElement(), getNamespace(), GeneralAddressClass.getName(getDDMSVersion()));
		super.validate();
	}
	...
	public boolean equals(Object obj) {
		if (!super.equals(obj) || !(obj instanceof GeneralAddressClass))
			return (false);
		return (true);
	}
	...
	public static class Builder extends AbstractTspiAddress.Builder {
		 ...
		 */
		public Builder(GeneralAddressClass address) {
			super(address);
		}
		 ...
		 * @see IBuilder#commit()
		 */
		public GeneralAddressClass commit() throws InvalidDDMSException {
			if (isEmpty())
				return (null);
			return (new GeneralAddressClass(commitXml()));
		}
	}
}