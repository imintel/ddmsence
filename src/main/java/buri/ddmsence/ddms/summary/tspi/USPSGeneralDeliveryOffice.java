 ...
 * @since 2.2.0
 */
public final class USPSGeneralDeliveryOffice extends AbstractTspiAddress {
	 ...
	 */
	public USPSGeneralDeliveryOffice(Element element) throws InvalidDDMSException {
		super(element);
	}
	...
	protected void validate() throws InvalidDDMSException {
		Util.requireQName(getXOMElement(), getNamespace(), USPSGeneralDeliveryOffice.getName(getDDMSVersion()));
		super.validate();
	}
	...
	public static String getName(DDMSVersion version) {
		...
		return ("USPSGeneralDeliveryOffice");
	}
	...
	public boolean equals(Object obj) {
		if (!super.equals(obj) || !(obj instanceof USPSGeneralDeliveryOffice))
			return (false);
		return (true);
	}
	...
	public static class Builder extends AbstractTspiAddress.Builder {
		 ...
		 */
		public Builder(USPSGeneralDeliveryOffice address) {
			super(address);
		}
		 ...
		 * @see IBuilder#commit()
		 */
		public USPSGeneralDeliveryOffice commit() throws InvalidDDMSException {
			if (isEmpty())
				return (null);
			return (new USPSGeneralDeliveryOffice(commitXml()));
		}
	}
}