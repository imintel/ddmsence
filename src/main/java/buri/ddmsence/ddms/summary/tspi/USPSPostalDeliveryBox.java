 ...
 * @since 2.2.0
 */
public final class USPSPostalDeliveryBox extends AbstractTspiAddress {
	 ...
	 */
	public USPSPostalDeliveryBox(Element element) throws InvalidDDMSException {
		super(element);
	}
	...
	protected void validate() throws InvalidDDMSException {
		Util.requireQName(getXOMElement(), getNamespace(), USPSPostalDeliveryBox.getName(getDDMSVersion()));
		super.validate();
	}
	...
	public boolean equals(Object obj) {
		if (!super.equals(obj) || !(obj instanceof USPSPostalDeliveryBox))
			return (false);
		return (true);
	}
	...
	public static class Builder extends AbstractTspiAddress.Builder {
		 ...
		 */
		public Builder(USPSPostalDeliveryBox address) {
			super(address);
		}
		 ...
		 * @see IBuilder#commit()
		 */
		public USPSPostalDeliveryBox commit() throws InvalidDDMSException {
			if (isEmpty())
				return (null);
			return (new USPSPostalDeliveryBox(commitXml()));
		}
	}
}