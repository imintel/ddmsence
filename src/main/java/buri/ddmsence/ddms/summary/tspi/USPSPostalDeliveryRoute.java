 ...
 * @since 2.2.0
 */
public final class USPSPostalDeliveryRoute extends AbstractTspiAddress {
	 ...
	 */
	public USPSPostalDeliveryRoute(Element element) throws InvalidDDMSException {
		super(element);
	}
	...
	protected void validate() throws InvalidDDMSException {
		Util.requireQName(getXOMElement(), getNamespace(), USPSPostalDeliveryRoute.getName(getDDMSVersion()));
		super.validate();
	}
	...
	public static String getName(DDMSVersion version) {
		...
		return ("USPSPostalDeliveryRoute");
	}
	...
	public boolean equals(Object obj) {
		if (!super.equals(obj) || !(obj instanceof USPSPostalDeliveryRoute))
			return (false);
		return (true);
	}
	...
	public static class Builder extends AbstractTspiAddress.Builder {
		 ...
		 */
		public Builder(USPSPostalDeliveryRoute address) {
			super(address);
		}
		 ...
		 * @see IBuilder#commit()
		 */
		public USPSPostalDeliveryRoute commit() throws InvalidDDMSException {
			if (isEmpty())
				return (null);
			return (new USPSPostalDeliveryRoute(commitXml()));
		}
	}
}