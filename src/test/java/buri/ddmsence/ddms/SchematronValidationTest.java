    ...
    public void testSchematronValidationXslt1() throws InvalidDDMSException, IOException, XSLException {
        ...
        for (String processor : supportedXslt1Processors) {
            ...
            for (String sVersion : getSupportedVersions()) {
                ...
                System.out.println("data/test/" + sVersion
                        + "/testSchematronXslt1.sch");
                ///Users/ckcook/code/sub/ddmsence/src/main/resources/data/test/2.0
                //data.test.2.0
                //
                File is = new File("src/main/resources/data/test/"+sVersion+"/testSchematronXslt1.sch");
                System.out.println(is.getAbsolutePath());
                List<ValidationMessage> messages = resource.validateWithSchematron(is);
    ...
    public void testSchematronValidationXslt2() throws InvalidDDMSException, IOException, XSLException {
        ...
        for (String processor : supportedXslt1Processors) {
            ...
            for (String sVersion : getSupportedVersions()) {
                ...
                List<ValidationMessage> messages = resource.validateWithSchematron(new File("src/main/resources/data/test/" + sVersion
    ...
    public void testSchematronValidationInvalid() throws InvalidDDMSException, IOException, XSLException {
        ...
        for (String processor : supportedXslt1Processors) {
            ...
            for (String sVersion : getSupportedVersions()) {
                Resource resource = versionToResourceMap.get(sVersion);
                try {
                    resource.validateWithSchematron(new File("src/main/resources/data/test/" + sVersion + "/testSchematronInvalid.sch"));
