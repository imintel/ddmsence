...
public class DDMSVersionTest extends AbstractBaseTestCase {
	...
	public void testGetCurrentSchema() {
		assertEquals("/data/schemas/5.0/DDMS/ddms.xsd", DDMSVersion.getCurrentVersion().getSchema());
	}
	...
	public void testGetSchemaForValid() {
		...
		assertEquals("/data/schemas/2.0/DDMS/ddms.xsd", DDMSVersion.getCurrentVersion().getSchema());
	...
	public void testAccessors() {
		...
		assertEquals("/data/schemas/3.0/DDMS/ddms.xsd", version.getSchema());
		assertEquals("http://www.opengis.net/gml/3.2", version.getGmlNamespace());
		assertEquals("/data/schemas/3.0/DDMS/gml.xsd", version.getGmlSchema());
		assertEquals("urn:us:gov:ic:ism", version.getIsmNamespace());
		assertEquals("/data/schemas/3.0/ISM/CVE/", version.getIsmCveLocation());

		version = DDMSVersion.setCurrentVersion("4.1");
		assertEquals("urn:us:gov:ic:ntk", version.getNtkNamespace());
		assertEquals("/data/schemas/4.1/NTK/IC-NTK.xsd", version.getNtkSchema());
	}
